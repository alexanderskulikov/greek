...
\begin{document}
    ...
    \begin{page}
        \mysubsection{\emoji{stopwatch} Present tense}
    ...
    \begin{page}
    	\mysubsection{\emoji{rocket} Future simple tense}
    	\mysubsubsection{\emoji{one} -ω}
    	\begin{tabular}{rcll}
    		\multicolumn{4}{c}{\my{ζ, v $\to$ σ}}\\
			διαβάζω & \emoji{book} & θα διαβάσω & \my{to read}\\
			τελειώνω & \emoji{white-check-mark} & θα τελειώσω & \my{to finish}\\
			%
			\multicolumn{4}{c}{\my{γ, χ, χν, σκ $\to$ ξ}}\\
			...
			%
			\multicolumn{4}{c}{\my{εύ $\to$ έψ}}\\
			δουλεύω & \emoji{office} & θα δουλέψω & \my{to work}\\
			%
			\multicolumn{4}{c}{\my{irregular}}\\
    ...
    \begin{page}
        \mysubsubsection{\emoji{person-juggling} Irregular verbs}
        %\footnotesize
        \begin{tabular}{rcll}
            \multicolumn{4}{c}{-ω, -εις, -ει, -ουμε, -ετε, -ουν}\\
            [2mm]
            πλένω & \emoji{bathtub} & θα πλύνω & \my{to wash}\\
