...
\usepackage[paperheight=156mm, paperwidth=87.75mm, margin=4mm]{geometry}
	...
	\begin{page}
		...
		\begin{textblock}
			\begin{description}
                ...
                \item[Национальная Гвардия.] Объединенные вооруженные силы (сухопутные, морские и~авиационные). Служат только греко-киприоты. С~2008 года военная служба обязательна для всех членов Греческого Сообщества, а не только для этнических греков.
				...
				в~одном месте (удостоверения, медицинские карты, лицензии, паспорта, свидетельства о~рождении, регистрация автомобилей).
			\end{description}
		\end{textblock}
	\end{page}
\end{document}