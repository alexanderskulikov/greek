...
\begin{document}
	...
	\normalsize
	\vfill
	%\includegraphics{tobe.jpg}

	\clearpage
    \vfill
	\mysubsection{\emoji{person-running} -ω}
	\begin{tabular}{rcl}
	...
	\clearpage
    \null\vfill
    \mysubsection{\emoji{man-walking} -ομαι}
    \begin{tabular}{rcl}
	...
	\begin{tabular}{rcl}
		...
		παλιός & \emoji{amphora} & \my{old (things only)}\\[2mm]
		γλυκός & \emoji{lollipop} & \my{sweet}\\[2mm]
		...
		χοντρός & \emoji{wood} & \my{thick}\\[2mm]
		ζεστός & \emoji{sun} & \my{warm}\\
		κρύος & \emoji{cold-face} & \my{cold}\\[2mm]
