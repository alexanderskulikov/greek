...
%\newenvironment{description}{\clearpage\normalsize\null\vfill}{\vfill\null}
...
\newcommand{\mysubsubsection}[1]{\subsubsection*{\my{#1}}}
...
%        \end{tabular}
	...
	\begin{page}
		\mysubsubsection{-ω, -εις, -ει, -ουμε, -ετε, -ουν}
		\begin{tabular}{rcl}
	...
	\begin{page}
		\mysubsubsection{-άω, -άς, -άει, -άμε, άτε, άνε}
		\begin{tabular}{rcl}
		...
		\end{tabular}
		\vfill
		\mysubsubsection{-ώ, -είς, -εί, -ούμε, -είτε, -ούν}
		\begin{tabular}{rcl}
	...
	\begin{page}
	    \mysubsubsection{-ομαι, -εσαι, -εται, -όμαστε, -εστε, -ονται}
	    \begin{tabular}{rcl}
	    ...
	    \end{tabular}
	    \vfill
	    \mysubsubsection{-άμαι, -άσαι, -άται, -όμαστε, -άστε, -ονται}
	    \begin{tabular}{rcl}
...
%            &καταλαβαίνω & \emoji{thought-balloon} & θα καταλάβω & \my{to understand}\\
    ...
    \begin{page}
        %\mysubsubsection{\emoji{triangular-flag-on-post} Ανώμαλα ρήματα
             %(irregular verbs)}
        \mysubsubsection{Неправильные глаголы}
        \scriptsize
        \begin{tabular}{rclll}
            %\toprule
    ...
    \begin{page}
%        \mysubsection{\emoji{fast-reverse-button} Αόριστος (past tense)}
        \mysubsection{Прошедшее}
        \begin{tabular}{rrrrrr}
            & & κάνω & τρώω\\
...
%           (irregular verbs)}
    ...
    \begin{page}
        ...
        \mysubsection{Простое сослагательное}
        %\small
        \begin{tabular}{lrcl}
    ...
    \begin{page}
        \mysection{Существительные}
        %\mysection{\emoji{people-holding-hands} Plural}
        \mysubsection{Множественное}
        \begin{tabular}{rrrrrr}
...
%		\mysubsection{\emoji{firefighter} Professions}
    ...
    \begin{page}
        \mysection{Совет министров}
        \scriptsize
        \begin{tabular}{p{50mm}p{34mm}}
            Πρόεδρος \newline\my{President} & Νίκος Χριστοδουλίδης\newline \my{Nikos Christodoulides} \\

            Υπουργός Εξωτερικών \newline\my{Minister of Foreign Affairs} & Κωνσταντίνος Κόμπος\newline \my{Konstantinos Kompos} \\

            Υπουργός Εσωτερικών \newline\my{Minister of Interior} & Κωνσταντίνος Ιωάννου
            \newline \my{Konstantinos Ioannou} \\

            Υπουργός Οικονομικών \newline\my{Minister of Finance} & Μάκης Κεραυνός \newline\my{Makis Keravnos} \\

            Υπουργός Ενέργειας, Εμπορίου, Βιομηχανίας και Τουρισμού \newline\my{Minister of Energy, Commerce, Industry and Tourism} & Γιώργος Παπαναστασίου \newline\my{Giorgos Papanastasiou} \\

            Υπουργός Εργασίας και Κοινωνικών Ασφαλίσεων \newline\my{Minister of Labour and Social Insurance} & Γιάννης Παναγιώτου \newline\my{Giannis Panayiotou} \\

            Υπουργός Γεωργίας, Αγροτικής Ανάπτυξης και Περιβάλλοντος \newline\my{Minister of Agriculture, Natural Resources and Environment} & Μαρία Παναγιώτου \newline\my{Maria Panayiotou} \\

            Υπουργός Παιδείας και Πολιτισμού \newline\my{Minister of Education and Culture} & Αθηνά Μιχαηλίδου \newline\my{Athina Michailidou} \\

            Υπουργός Δικαιοσύνης και Δημοσίας Τάξεως \newline\my{Minister of Justice and Public Order} & Μάριος Χαρτσιώτης \newline\my{Marios Hartsiotis} \\

            Υπουργός Άμυνας \newline\my{Minister of Defence} & Βασίλης Πάλμας \newline\my{Vasilis Palmas} \\

            Υπουργός Μεταφορών, Επικοινωνιών και Έργων \newline\my{Minister of Transport, Communications and Works} & Αλέξης Βαφειάδης \newline\my{Alexis Vafiadis} \\

            Υπουργός Υγείας \newline\my{Minister of Health} & Μιχάλης Δαμιανός \newline\my{Michalis Damianos} \\

            Κυβερνητικός Εκπρόσωπος \newline\my{Government Spokesman} & Κωνσταντίνος Λετυμπιώτης \newline\my{Konstantinos Letimpiotis} \\
        \end{tabular}
    \end{page}
