...
%		\subsection{\emoji{firefighter} Professions}
	...
	\begin{page}
		...
		\begin{tabular}{rp{70mm}}
			\scriptsize 01.01 & \scriptsize Πρωτοχρονιά \my{(Новый год)}
			...
			\scriptsize 06.01 & \scriptsize Θεοφάνεια \my{(Богоявление)}
			\tiny\newline Αγιασμός των υδάτων· στις ακτές γίνεται κατάδυση για τον σταυρό\newline
			\my{Освящение воды; на побережье — ныряние за крестом}\\
			
			\scriptsize 25.03 & \scriptsize 25η Μαρτίου \my{(День греческой независимости)}
			...
			\scriptsize 01.04 & \scriptsize 1η Απριλίου \my{(Начало борьбы EOKA)}
			...
			\scriptsize Πάσχα & \scriptsize Πάσχα \my{(Пасха)}
			\tiny\newline Αναστάσιμη λειτουργία, οικογενειακό τραπέζι, βαμμένα αυγά, ψήσιμο κρέατος· αργία τη Δευτέρα\newline
			\my{Ночная служба, семейное застолье, крашеные яйца, шашлыки; выходной понедельник}\\
			
			\scriptsize 01.05 & \scriptsize Πρωτομαγιά \my{(День труда)}
			\tiny\newline Πικνίκ, εξορμήσεις στη φύση, μερικές φορές συγκεντρώσεις\newline
			\my{Пикники, выезды на природу, иногда митинги}\\
			
			\scriptsize 15.08 & \scriptsize Κοίμηση της Θεοτόκου \my{(Успение Богородицы)}
