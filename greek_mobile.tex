...
\begin{document}
	...
	\begin{page}
		...
		\mysubsubsection{\emoji{person-running} -ω, -εις, -ει, -ουμε, -ετε, -ουν}
		\begin{tabular}{rcl}
	...
	\begin{page}
		\mysubsubsection{\emoji{singer} -άω, -άς, -άει, -άμε, άτε, άνε}
		\begin{tabular}{rcl}
		...
		\end{tabular}
		\vfill
		\mysubsubsection{\emoji{car} -ώ, -είς, -εί, -ούμε, -είτε, -ούν}
		\begin{tabular}{rcl}
	...
	\begin{page}
	    \mysubsubsection{\emoji{man-walking} -ομαι, -εσαι, -εται, -όμαστε, -εστε, -ονται}
	    \begin{tabular}{rcl}
	    ...
	    \end{tabular}
	    \vfill
	    \mysubsubsection{\emoji{zzz} -άμαι, -άσαι, -άται, -όμαστε, -άστε, -ονται}
	    \begin{tabular}{rcl}
	...
	\begin{page}
		\mysubsubsection{\emoji{memo} Summary}
	    \scriptsize
    ...
    \begin{page}
        \mysubsection{\emoji{hourglass-not-done} Past simple tense}
        ...
        \begin{tabular}{rcll}
            ...
            βγάζω & \emoji{door} & θα βγάλω & \my{to go out}\\
