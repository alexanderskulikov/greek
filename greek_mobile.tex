...
%	\end{page}
	...
	\begin{page}
		...
		\begin{textblock}
			Κάνω δουλειές στο σπίτι κάθε μέρα. (Я делаю домашние дела каждый день.)
			Βοηθάω την οικογένειά μου. (Я помогаю своей семье.)
			Καθαρίζω το δωμάτιό μου. (Я убираю свою комнату.)
			%Σκουπίζω το πάτωμα. (Я подметаю пол.)
			Πλένω τα πιάτα μετά το φαγητό. (Я мою посуду после еды.)
			Μερικές φορές μαγειρεύω απλό φαγητό. (Иногда я готовлю простую еду.)
			Βάζω τα ρούχα στο πλυντήριο. (Я кладу одежду в стиральную машину.)
			%Σιδερώνω τα ρούχα το Σαββατοκύριακο. (Я глажу одежду на выходных.)
			Μου αρέσει όταν το σπίτι είναι καθαρό. (Мне нравится, когда дом чистый.)
			Οι δουλειές στο σπίτι είναι σημαντικές. (Домашние дела важны.)
		\end{textblock}
	\end{page}
	...
	\begin{page}
		...
		\begin{textblock}
			Το ιδανικό μου σπίτι είναι μεγάλο και άνετο. (Мой идеальный дом большой и удобный.)
			Έχει πολλά δωμάτια για την οικογένειά μου. (В нем много комнат для моей семьи.)
			Το σπίτι είναι φωτεινό και καθαρό. (Дом светлый и чистый.)
			Έχει μια μεγάλη κουζίνα. (В нем есть большая кухня.)
			Μου αρέσει να έχω ένα όμορφο σαλόνι. (Мне нравится иметь красивую гостиную.)
			Από το σπίτι βλέπω τη θάλασσα. (Из дома я вижу море.)
			Κοντά στο σπίτι υπάρχει πολύ πράσινο. (Рядом с домом много зелени.)
			Υπάρχει ένας μικρός κήπος. (Есть маленький сад.)
			Μπορώ να ξεκουράζομαι εκεί κάθε μέρα. (Я могу отдыхать там каждый день.)
			Το ιδανικό μου σπίτι είναι ήσυχο και όμορφο. (Мой идеальный дом тихий и красивый.)
		\end{textblock}
	\end{page}
	...
	\begin{page}
		...
		\begin{textblock}
			Εργάζομαι ως δάσκαλος στο πανεπιστήμιο. (Я работаю преподавателем в университете.)
			Διδάσκω μαθήματα μαθηματικών. (Я преподаю курсы по математике.)
			Μου αρέσει πολύ η δουλειά μου. (Мне очень нравится моя работа.)
			Κάθε μέρα πηγαίνω στο πανεπιστήμιο. (Каждый день я хожу в университет.)
			Δουλεύω με φοιτητές. (Я работаю со студентами.)
			Μου αρέσει να βοηθάω τους φοιτητές. (Мне нравится помогать студентам.)
			Μιλάμε για μαθηματικά στην τάξη. (Мы говорим о математике на занятии.)
			Μερικές φορές γράφω στον πίνακα. (Иногда я пишу на доске.)
			Διαβάζω και ετοιμάζω τα μαθήματα στο σπίτι. (Я читаю и готовлю занятия дома.)
			Είμαι χαρούμενος με τη δουλειά μου. (Я доволен своей работой.)
		\end{textblock}
	\end{page}
	...
	\begin{page}
		...
		\begin{textblock}
			Εργάζομαι ως δάσκαλος στο πανεπιστήμιο. (Я работаю преподавателем в университете.)
			Η δουλειά μου έχει θετικά και αρνητικά. (У моей работы есть плюсы и минусы.)
			Μου αρέσει να δουλεύω με φοιτητές. (Мне нравится работать со студентами.)
			Οι φοιτητές είναι έξυπνοι και ενδιαφέροντες. (Студенты умные и интересные.)
			Μου αρέσει να διδάσκω μαθηματικά. (Мне нравится преподавать математику.)
			Είναι ωραίο να βοηθάω τους φοιτητές. (Приятно помогать студентам.)
			Μερικές φορές η δουλειά είναι δύσκολη. (Иногда работа трудная.)
			Έχω πολύ δουλειά κάθε μέρα. (У меня много работы каждый день.)
			Μερικές φορές είμαι πολύ κουρασμένος. (Иногда я очень устаю.)
			Αλλά γενικά είμαι χαρούμενος με τη δουλειά μου. (Но в целом я доволен своей работой.)
		\end{textblock}
	\end{page}
