...
%	\end{page}
	...
	\begin{page}
		%\section{Ερωτήσεις για τα προφορικά (вопросы для разговорной практики)}
		%\subsection{Κάνετε δουλειές στο σπίτι; (Занимаетесь домашними делами?)}
		\section{Вопросы для разговорной практики}
	...
	\begin{page}
		...
		\begin{textblock}
			Εργάζομαι ως δάσκαλος στο πανεπιστήμιο.\\
	...
	\begin{page}
		...
		\begin{textblock}
			Αγαπημένη μου Άννα,\\
			Έχω πολύ καιρό να σε δω! Τι κάνεις;
		...
		\begin{textblock}
			Αγαπητοί πελάτες,\\
			Θα θέλαμε να σας ενημερώσουμε ότι \dots\\[1mm]

			Αξιότιμοι κύριοι,\\
			Σας γράφω να \dots\\[1mm]
