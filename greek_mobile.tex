	...
	\begin{page}
		...
		\begin{textblock}
			\begin{description}
				...
				\item[Греческий.]
				Греко-киприоты являются православными христианами, в то время как турко-киприоты являются мусульманами. Однако на острове также проживают армяне, марониты и приверженцы римско-католической церкви.
				\item[ГеСИ.]
				Генеральная система здравоохранения (ГеСИ)~--- система здравоохранения, цель которой заключается в~предоставлении качественных медицинских услуг для застрахованных лиц.
				Посещение личного врача является бесплатным на определенное количество посещений в~год: 18--40 лет~--- 4~посещения, 47--50 лет~--- 6~посещений. 
				В~случае превышения данного количества посещений взимается плата в~размере 15~евро за каждое посещение. Прием у~врачей-специалистов стоит 6~евро, 
				за исключением рентгенологов, которые берут 10~евро за~прием.
				Каждый правообладатель может сделать чистку зубов у стоматолога бесплатно один раз в~год.
				\item[Газеты.]
				Самые известные ежедневные газет, выпускаемые на Кипре,~--- это Филеефтерос,
				Политис, Симерини и~Харавги. Самая известная еженедельная газета, выходящая каждое воскресенье,~--- это Кафимерини. Единственная англоязычная газета на Кипре~--- Сyprus Mail.
				\item[Телекоммуникации.] Код: 00357 (+357); телефонные компании: Cyta (АТЕН), Epic, Primetel и~Cablenet; гос. оператор: РИК.
				\item[Национальная Гвардия] представляет собой объединенные вооруженные силы
				Кипра, включающие сухопутные, морские и~авиационные силы. На данный момент только греко-киприоты служат в~Национальной Гвардии. С~2008 года военная служба обязательна для всех членов Греческого Сообщества, а не только для этнических греков.
				Продолжительность службы составляет 14 месяцев. Все мужчины в~возрасте 
				...
				\item[Спорт.] Футбол является самым популярным видом спорта на~Кипре. Самые известные
				Анортосис (Фамагуста).
				исторические команды: АЕЛ (Лимассол), АПОЭЛ (Никосия), Омония (Никосия) 
				и~Анортосис (Фамагуста).
				\item[Учреждения и часы работы.] 
				Большинство государственных служб работают с понедельника по пятницу 
				с~7:30--8:00
				утра до~14:00--15:00 дня.
				Аптеки работают до~13:30 по средам и субботам. В~воскресенье они не работают. Про дежурные аптеки можно узнать по номеру 11892. Летом ночные аптеки работают до 23:00.
				Банки работают с~8:00 утра до 14:30 дня.
				АНК (Управление электроэнергетики кипра): подача электроэнергии
				Департаменты водоснабжения Кипра: подача воды.
				КЕП (Центр обслуживания граждан): предоставление государственных услуг 
				в~одном месте (удостоверения, медицинские карты, лицензии, паспорта, свидетельства о~рождении, регистрация автомобилей и т.д.)
			\end{description}
		\end{textblock}
	\end{page}
\end{document}